<div class="app-menu">
    ...
    <div class="logo-box">
        ...
        <a href="index.html" class="logo-light">
            <img width-20px height-10px src="https://yt3.googleusercontent.com/zCqQxIXZvzHVt-A00tl6Ust7vhKiE6RwAlx_q-QYh7cIOPSSS8C0_94nu8zFxi_upEtUtlfcPQ=s900-c-k-c0x00ffffff-no-rj"
                alt="logo" class="logo-lg">
            <img src="https://yt3.googleusercontent.com/zCqQxIXZvzHVt-A00tl6Ust7vhKiE6RwAlx_q-QYh7cIOPSSS8C0_94nu8zFxi_upEtUtlfcPQ=s900-c-k-c0x00ffffff-no-rj"
        ...
        <ul class="menu">
            ...
            <li class="menu-item">
                <a href="#menuEcommerce" data-bs-toggle="collapse" class="menu-link">
                    <span class="menu-icon"><i data-feather="headphones"></i></span>
